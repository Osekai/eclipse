    ...
    <div otab-container otab-no-replace>
        <div class="medals__toolbar">
            <div class="medals__toolbar-buttons medals__toolbar-left">
                <div otab-button="Medals" class="tooltip-v2" tooltip-content="<?= GetStringRaw("medals", "toolbar.tab.medals"); ?>"><i class="oif-medal"></i>
                </div>
                    ...
                    <div class="medals__search__area">
                        <div class="medals__search__bar">
                            <div class="medals__search">
                                ...
                                <input type="text" id="txtMedalSearch" class="medals__search-input" placeholder="<?= GetStringRaw("medals", "searchbar.placeholder"); ?>">
                            </div>
                            <div class="medals__search__filters-icon tooltip-v2" tooltip-content="<?= GetStringRaw("medals", "searchbar.filters.tooltip"); ?>">
            ...
            <div class="medals__toolbar-buttons medals__toolbar-right">
                <div onclick="randomMedal();" class="tooltip-v2" tooltip-content="<?= GetStringRaw("medals", "toolbar.randomMedal"); ?>"><i class="fas fa-dice"></i>
                </div>
                <div onclick="landingPage()" id="expandbutton" class="tooltip-v2" tooltip-content="<?= GetStringRaw("medals", "toolbar.homepage"); ?>"><i class="fas fa-expand"></i>
                </div>
            </div>
        </div>
            ...
            <div class="osekai__3col-panels">
                <div id="osekai__col1" class="osekai__3col_col1 medals__nomedal">
                    <div class="medals__otab-container">
                        ...
                        <div class="medals__scroller osekai__otab-hidden" otab-name="Beatmap Packs" otab-callback="loadBeatmapPacks">
                            ...
                            <section class="osekai__panel medals__solution-panel">
                                <div class="medals__info osekai__panel-header" id="medal__info">
                                    ...
                                    <div class="osekai__mi-text">
                                        ...
                                        <span id="stable-only" class="hidden stable__only tooltip-v2" tooltip-content="This medal can only be achieved on Stable."><i class="fas fa-exclamation-triangle"></i> Stable Only</span>
                                    </div>
                                </div>
